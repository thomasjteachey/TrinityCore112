...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_ACCOUNT_BANK_ITEM_DATA,
    CHAR_SEL_ACCOUNT_BANK_ITEM_FULL,
    ...
    CHAR_DEL_ACCOUNT_BANK_ITEMS_BY_ACCOUNT,
    CHAR_UPD_ITEM_OWNER,
    ...
    CHAR_REP_TRANSMOG,
    CHAR_DEL_TRANSMOG,
    CHAR_SEL_TRANSMOG_SETTINGS,
    CHAR_REP_TRANSMOG_SETTINGS,

    CHAR_SEL_VHR_RUN_TALENTS,
    CHAR_INS_VHR_RUN_TALENT,
    CHAR_DEL_VHR_RUN_TALENT,
    CHAR_DEL_VHR_RUN_TALENTS,
    ...
    CHAR_INS_WEEKLY_HONOR_POINTS,
    CHAR_SEL_WEEKLY_HONOR_TOP,
    CHAR_SEL_WEEKLY_HONOR_TOP_THREE,
    CHAR_UPD_WEEKLY_HONOR_RESET,
    CHAR_SEL_WARCHIEF_HONOR,
    CHAR_UPD_WARCHIEF_HONOR,
    ...
    CHAR_SEL_CHAR_SKILL_COUNT_BY_GUID,
    CHAR_INS_CHAR_SPELL,
    CHAR_DEL_CHAR_STATS,
    CHAR_INS_CHAR_STATS,

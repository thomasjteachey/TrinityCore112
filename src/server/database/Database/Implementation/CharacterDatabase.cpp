...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(CHAR_SEL_WEEKLY_HONOR_TOP_THREE, "SELECT chw.guid, chw.weekly_honor FROM character_honor_weekly chw INNER JOIN characters c ON chw.guid = c.guid ORDER BY chw.weekly_honor DESC, chw.guid ASC LIMIT 3", CONNECTION_SYNCH);

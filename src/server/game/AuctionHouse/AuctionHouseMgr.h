...
class TC_GAME_API AuctionHouseMgr
{
    ...
    public:
        ...
        // pending list and collects the deposit it still owes;
        // AuctionHouseObject::RemoveAuction calls it before the entry is
        // deleted. Returns how much of the deposit was actually collected -
        // aEntry->deposit when the auction was not pending at all, because
        // PendingAuctionProcess has already charged it.
        uint32 PendingAuctionRemove(AuctionEntry const* aEntry);

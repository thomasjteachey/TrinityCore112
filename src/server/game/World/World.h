...
enum WorldBoolConfigs : uint32
{
    ...
    CONFIG_CENTURION_BG_XP_INSTEAD_OF_HONOR,
    CONFIG_CENTURION_QUIVERS_HOLD_ANY_ITEM,
    CONFIG_CENTURION_FEAR_OTHERS_BREAK_INSTANTLY,
    CONFIG_CENTURION_BG_SPOILS_ENABLE,
...
enum WorldFloatConfigs : uint32
{
    ...
    CONFIG_CENTURION_BG_ARENA_EXPERIENCE_MULTIPLIER,
...
enum WorldIntConfigs : uint32
{
    ...
    CONFIG_CONDITIONAL_MAX_HONOR_POINTS,
    CONFIG_CONDITIONAL_MAX_HONOR_POINTS_2,
    CONFIG_CONDITIONAL_MAX_HONOR_SPELL,
    CONFIG_CONDITIONAL_MAX_HONOR_SPELL_2,
    CONFIG_CONDITIONAL_MAX_HONOR_QUEST,
    CONFIG_CONDITIONAL_MAX_HONOR_QUEST_2,
    ...
    CONFIG_ANY_CLASS_TRAINER_CREATURE,
    ...
    CONFIG_CENTURION_BREAKABLE_CC_DAMAGE_AT_CAP,
    CONFIG_CENTURION_FEAR_DAMAGE_AT_CAP,
    CONFIG_CENTURION_ENTANGLING_ROOTS_DAMAGE_AT_CAP,
    CONFIG_CENTURION_FROST_NOVA_DAMAGE_AT_CAP,
    ...
    CONFIG_CENTURION_BG_XP_HONOR_PER_LEVEL,
    CONFIG_CENTURION_BG_SPOILS_FIRST_ITEM,
    CONFIG_CENTURION_BG_SPOILS_LOSER_CHANCE,
    CONFIG_CENTURION_BG_SPOILS_MIN_PRESENCE,

...
TC_API_EXPORT EnumText EnumUtils<CreatureFlagsExtra>::ToString(CreatureFlagsExtra value)
{
    switch (value)
    {
        ...
        case CREATURE_FLAG_EXTRA_FREE_RESURRECT: return { "CREATURE_FLAG_EXTRA_FREE_RESURRECT", "CREATURE_FLAG_EXTRA_FREE_RESURRECT", "spirit healer resurrects without resurrection sickness or durability loss" };
...
TC_API_EXPORT CreatureFlagsExtra EnumUtils<CreatureFlagsExtra>::FromIndex(size_t index)
{
    switch (index)
    {
        ...
        case 22: return CREATURE_FLAG_EXTRA_FREE_RESURRECT;
...
TC_API_EXPORT size_t EnumUtils<CreatureFlagsExtra>::ToIndex(CreatureFlagsExtra value)
{
    switch (value)
    {
        ...
        case CREATURE_FLAG_EXTRA_FREE_RESURRECT: return 22;

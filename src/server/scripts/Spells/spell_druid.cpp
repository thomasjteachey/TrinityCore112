...
class spell_dru_innervate : public AuraScript
{
    ...
    void Register() override
    {
        ...
        AfterEffectApply += AuraEffectApplyFn(spell_dru_innervate::HandleApply, EFFECT_0, SPELL_AURA_PERIODIC_ENERGIZE, AURA_EFFECT_HANDLE_REAL);
    }
};

class spell_dru_thinnervate : public AuraScript
{
    PrepareAuraScript(spell_dru_thinnervate);
...
void AddSC_druid_spell_scripts()
{
    ...
    RegisterSpellScript(spell_dru_thinnervate);

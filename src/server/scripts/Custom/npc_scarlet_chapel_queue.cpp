...
constexpr uint32 ACTION_QUEUE_GUNSHIP_REGULAR = GOSSIP_ACTION_INFO_DEF + 7;
constexpr uint32 ACTION_QUEUE_GUNSHIP_ALLIANCE = GOSSIP_ACTION_INFO_DEF + 8;
constexpr uint32 ACTION_QUEUE_GUNSHIP_HORDE = GOSSIP_ACTION_INFO_DEF + 9;
constexpr uint32 ACTION_CLOSE = GOSSIP_ACTION_INFO_DEF + 10;
...
public:
    ...
    struct npc_scarlet_chapel_queueAI : public ScriptedAI
    {
        ...
        bool OnGossipHello(Player* player) override
        {
            ...
            AddGossipItemFor(player, GOSSIP_ICON_BATTLE, "Queue for Gunship Deathmatch", GOSSIP_SENDER_MAIN, ACTION_QUEUE_GUNSHIP_REGULAR);
            AddGossipItemFor(player, GOSSIP_ICON_BATTLE, "Queue for Gunship Deathmatch (Force Alliance side)", GOSSIP_SENDER_MAIN, ACTION_QUEUE_GUNSHIP_ALLIANCE);
            AddGossipItemFor(player, GOSSIP_ICON_BATTLE, "Queue for Gunship Deathmatch (Force Horde side)", GOSSIP_SENDER_MAIN, ACTION_QUEUE_GUNSHIP_HORDE);
        ...
        bool OnGossipSelect(Player* player, uint32, uint32 gossipListId) override
        {
            ...
            switch (action)
            {
                ...
                case ACTION_QUEUE_GUNSHIP_REGULAR: return HandleQueue(player, BATTLEGROUND_GS, "Gunship Deathmatch", TEAM_NEUTRAL);
                case ACTION_QUEUE_GUNSHIP_ALLIANCE: return HandleQueue(player, BATTLEGROUND_GS, "Gunship Deathmatch", TEAM_ALLIANCE);
                case ACTION_QUEUE_GUNSHIP_HORDE: return HandleQueue(player, BATTLEGROUND_GS, "Gunship Deathmatch", TEAM_HORDE);

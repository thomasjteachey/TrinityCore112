...
void AutoBalance_AllCreatureScript::OnBeforeCreatureSelectLevel(const CreatureTemplate* /*creatureTemplate*/, Creature* creature, uint8& level)
{
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance:: ------------------------------------------------");
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::OnBeforeCreatureSelectLevel: Creature {} ({}) | Entry ID: ({}) | Spawn ID: ({})",
            creature->GetName(),
            level,
            creature->GetEntry(),
            creature->GetSpawnId()
        ...
        {
            TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::OnBeforeCreatureSelectLevel: Creature {} ({}) | has already been processed, using level {}.",
                creature->GetName(),
        ...
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::OnBeforeCreatureSelectLevel: Creature {} ({}) | is in map {} ({}{}{}{})",
            creature->GetName(),
            level,
        ...
        if (isCreatureRelevant(creature))
        {
            ...
            TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::OnBeforeCreatureSelectLevel: Creature {} ({}) | will spawn in as level ({}).",
                creature->GetName(),
                creatureABInfo->UnmodifiedLevel,
                creatureABInfo->selectedLevel
            );
        ...
        else
        {
            ...
            TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::OnBeforeCreatureSelectLevel: Creature {} ({}) | will spawn in at its original level ({}).",
                creature->GetName(),
                creatureABInfo->UnmodifiedLevel,
                creatureABInfo->selectedLevel
            );
...
void AutoBalance_AllCreatureScript::OnCreatureSelectLevel(const CreatureTemplate* /* cinfo */, Creature* creature)
{
    ...
    if (creatureABInfo->isBrandNew)
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::OnCreatureSelectLevel: Creature {} ({}) | Entry ID: ({}) | Spawn ID: ({})",
            creature->GetName(),
            creature->GetLevel(),
            creature->GetEntry(),
            creature->GetSpawnId()
        ...
        if (creatureABInfo->isBrandNew)
        {
            TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::OnCreatureSelectLevel: Creature {} ({}) | is no longer brand new.",
                creature->GetName(),
                creature->GetLevel()
            );
        ...
        {
            TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::OnCreatureSelectLevel: Creature {} ({}) | is set to level ({}).",
                creature->GetName(),
                creature->GetLevel(),
                creatureABInfo->selectedLevel
            );
    ...
    {
        TC_LOG_ERROR("module.AutoBalance", "AutoBalance_AllCreatureScript::OnCreatureSelectLevel: Creature {} ({}) | is new to the instance but wasn't flagged as brand new. Please open an issue.",
            creature->GetName(),
            creature->GetLevel()
        );
    }
...
void AutoBalance_AllCreatureScript::OnCreatureAddWorld(Creature* creature)
{
    if (creature->GetMap()->IsDungeon())
    {
        ...
        if (isCreatureRelevant(creature))
        {
            ...
            {
                TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::OnCreatureAddWorld: Creature {} ({}) | is set to level ({}) just after being added to the world.",
                    creature->GetName(),
                    creature->GetLevel(),
                    creatureABInfo->selectedLevel
                );
            ...
            if (creature->GetMaxHealth() != creatureABInfo->initialMaxHealth)
            {
                ...
                TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::OnCreatureAddWorld: Creature {} ({}) | had its max health changed from ({})->({}) just after being added to the world.",
                    creature->GetName(),
                    creature->GetLevel(),
                    oldMaxHealth,
        ...
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::OnCreatureAddWorld: Creature {} ({}) | added to map {} ({}{}{}{})",
            creature->GetName(),
            creature->GetLevel(),
            creatureMap->GetMapName(),
            creatureMap->GetId(),
...
void AutoBalance_AllCreatureScript::OnCreatureRemoveWorld(Creature* creature)
{
    if (creature->GetMap()->IsDungeon())
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::OnCreatureRemoveWorld: Creature {} ({}) | Entry ID: ({}) | Spawn ID: ({})",
            creature->GetName(),
            creature->GetLevel(),
            creature->GetEntry(),
            creature->GetSpawnId()
        ...
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::OnCreatureRemoveWorld: Creature {} ({}) | removed from map {} ({}{}{}{})",
            creature->GetName(),
            creature->GetLevel(),
            map->GetMapName(),
            map->GetId(),
...
void AutoBalance_AllCreatureScript::OnAllCreatureUpdate(Creature* creature, uint32 /*diff*/)
{
    ...
    if (ResetCreatureIfNeeded(creature))
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::OnAllCreatureUpdate: Creature {} ({}) | Entry ID: ({}) | Spawn ID: ({})",
            creature->GetName(),
            creature->GetLevel(),
            creature->GetEntry(),
            creature->GetSpawnId()
        ...
        if (creature->GetLevel() != creatureABInfo->selectedLevel && isCreatureRelevant(creature))
        {
            TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::OnAllCreatureUpdate: Creature {} ({}) | is set to level ({}).",
                creature->GetName(),
                creature->GetLevel(),
                creatureABInfo->selectedLevel
            );
...
bool AutoBalance_AllCreatureScript::ResetCreatureIfNeeded(Creature* creature)
{
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance:: ------------------------------------------------");
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ResetCreatureIfNeeded: Creature {} ({}) | is dead and mapConfigTime is not 0 - prime for reset if revived.", creature->GetName(), creature->GetLevel());
    ...
    if (creatureABInfo->mapConfigTime < mapABInfo->mapConfigTime)
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ResetCreatureIfNeeded: Creature {} ({}) | Entry ID: ({}) | Spawn ID: ({})",
            creature->GetName(),
            creature->GetLevel(),
            creature->GetEntry(),
            creature->GetSpawnId()
        ...
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ResetCreatureIfNeeded: Creature {} ({}) | Map config time is out of date ({} < {}). Resetting creature before modify.",
            creature->GetName(),
            creature->GetLevel(),
        ...
        {
            TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ResetCreatureIfNeeded: Creature {} ({}) | is set to level ({}).",
                creature->GetName(),
                creature->GetLevel(),
                unmodifiedLevel
            );
        ...
        {
            TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ResetCreatureIfNeeded: Creature {} ({}) | is already set to level ({}).",
                creature->GetName(),
                creature->GetLevel(),
                unmodifiedLevel
            );
        ...
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ResetCreatureIfNeeded: Creature {} ({}) is reset to its original stats.",
            creature->GetName(),
            creature->GetLevel()
        );
...
void AutoBalance_AllCreatureScript::ModifyCreatureAttributes(Creature* creature)
{
    ...
    if (!creature)
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: creature is null.");
        return;
    }
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | Map config time set to ({}).",
            creature->GetName(),
            creature->GetLevel(),
            mapABInfo->mapConfigTime
        );
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | is in map {} ({}{}{}{}) that is not enabled, not changed.",
            creature->GetName(),
            creatureABInfo->UnmodifiedLevel,
            map->GetMapName(),
            map->GetId(),
    ...
    if (!isCreatureRelevant(creature))
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | is not relevant, not changed.",
            creature->GetName(),
            creatureABInfo->UnmodifiedLevel
        );
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | is a {} outside of the expected NPC level range for the map ({} to {}), not modified.",
            creature->GetName(),
            creatureABInfo->UnmodifiedLevel,
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | was dead but appears to be alive now, reset wasAliveNowDead flag.", creature->GetName(), creatureABInfo->UnmodifiedLevel);
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | is dead, do not modify.", creature->GetName(), creatureABInfo->UnmodifiedLevel);
        return;
    }
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | is in the forced num players list with a value of 0, not changed.", creature->GetName(), creatureABInfo->UnmodifiedLevel);
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | is in the forced num players list with a value of {}, adjusting adjustedPlayerCount to match.", creature->GetName(), creatureABInfo->UnmodifiedLevel, forcedNumPlayers);
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | is on a map with no players, not changed.", creature->GetName(), creatureABInfo->UnmodifiedLevel);
        return;
    }
            ...
            )
    {
        ...
        {
            TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | is a {} that will not be level scaled, but will have modifiers set.",
                creature->GetName(),
                creatureABInfo->UnmodifiedLevel,
        ...
        else if (LevelScalingMethod == AUTOBALANCE_SCALING_DYNAMIC)
        {
            ...
            TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | scaled to level ({}) via dynamic scaling.",
                creature->GetName(),
                creatureABInfo->UnmodifiedLevel,
                selectedLevel
            );
        ...
        else
        {
            ...
            TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | scaled to level ({}) via fixed scaling.", creature->GetName(), creatureABInfo->UnmodifiedLevel, selectedLevel);
        }
        ...
        if (creature->GetLevel() != selectedLevel)
        {
            if (!creatureABInfo->isBrandNew)
            {
                TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | is set to new selectedLevel ({}).",
                    creature->GetName(),
                    creatureABInfo->UnmodifiedLevel,
                    selectedLevel
                );
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | not level scaled due to level scaling being disabled.", creature->GetName(), creatureABInfo->UnmodifiedLevel);
        creatureABInfo->selectedLevel = creatureABInfo->UnmodifiedLevel;
    }
    else if (creatureABInfo->neverLevelScale)
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | not level scaled due to being marked as multipliers only.", creature->GetName(), creatureABInfo->UnmodifiedLevel);
        creatureABInfo->selectedLevel = creatureABInfo->UnmodifiedLevel;
    }
    else
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | not level scaled due the instance's average creature level being inside the skip range.", creature->GetName(), creatureABInfo->UnmodifiedLevel);
        creatureABInfo->selectedLevel = creatureABInfo->UnmodifiedLevel;
    }

    if (creatureABInfo->isBrandNew)
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | is brand new, do not modify level or stats yet.",
            creature->GetName(),
            creatureABInfo->UnmodifiedLevel
        );
    ...
    //  Health Scaling
    //
    TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | ---------- HEALTH MULTIPLIER ----------",
        creature->GetName(),
        creatureABInfo->selectedLevel
    );
    ...
    TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | HealthMultiplier: ({}) = defaultMultiplier ({}) * statMod_global ({}) * statMod_health ({})",
        creature->GetName(),
        creatureABInfo->selectedLevel,
        healthMultiplier,
        defaultMultiplier,
    ...
    if (healthMultiplier <= MinHPModifier)
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | HealthMultiplier: ({}) - capped to MinHPModifier ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            healthMultiplier,
            MinHPModifier
    ...
    if (LevelScaling && creatureABInfo->selectedLevel != creatureABInfo->UnmodifiedLevel)
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | origHealth ({}) = origCreatureBaseStats->GenerateHealth(creatureTemplate)",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            origHealth
        );
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | newBaseHealth ({}) = getBaseExpansionValueForLevel(newCreatureBaseStats->BaseHealth, mapABInfo->highestPlayerLevel ({}))",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            newBaseHealth,
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | newHealth ({}) = newBaseHealth ({}) * creature ModHealth ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            newHealth,
            newBaseHealth,
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | newHealthMultiplier ({}) = newHealth ({}) / origHealth ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            newHealthMultiplier,
            newHealth,
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | scaledHealthMultiplier ({}) = healthMultiplier ({}) * newHealthMultiplier ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | newFinalHealth ({}) = origHealth ({}) * scaledHealthMultiplier ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            newFinalHealth,
            origHealth,
    ...
    else
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | scaledHealthMultiplier ({}) = healthMultiplier ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            scaledHealthMultiplier,
            healthMultiplier
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | newFinalHealth ({}) = origHealth ({}) * HealthMultiplier ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            newFinalHealth,
            origHealth,
    ...
    //  Mana Scaling
    //
    TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | ---------- MANA MULTIPLIER ----------",
        creature->GetName(),
        creatureABInfo->selectedLevel
    );
    ...
    TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | ManaMultiplier: ({}) = defaultMultiplier ({}) * statMod_global ({}) * statMod_mana ({})",
        creature->GetName(),
        creatureABInfo->selectedLevel,
        manaMultiplier,
        defaultMultiplier,
    ...
    if (manaMultiplier <= MinManaModifier)
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | ManaMultiplier: ({}) - capped to MinManaModifier ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            manaMultiplier,
            MinManaModifier
    ...
    if (!origCreatureBaseStats->GenerateMana(creatureTemplate))
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | Creature doesn't have mana, multiplier set to ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
    ...
    else
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | ManaMultiplier: ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            creatureABInfo->ManaMultiplier
        );
        ...
        if (LevelScaling && creatureABInfo->selectedLevel != creatureABInfo->UnmodifiedLevel)
        {
            ...
            TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | origMana ({}) = origCreatureBaseStats->GenerateMana(creatureTemplate)",
                creature->GetName(),
                creatureABInfo->selectedLevel,
                origMana
            );
            ...
            TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | newMana ({}) = newCreatureBaseStats->GenerateMana(creatureTemplate)",
                creature->GetName(),
                creatureABInfo->selectedLevel,
                newMana
            );
            ...
            TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | newManaMultiplier ({}) = newMana ({}) / origMana ({})",
                creature->GetName(),
                creatureABInfo->selectedLevel,
                newManaMultiplier,
                newMana,
            ...
            TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | scaledManaMultiplier ({}) = manaMultiplier ({}) * newManaMultiplier ({})",
                creature->GetName(),
                creatureABInfo->selectedLevel,
            ...
            TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | newFinalMana ({}) = origMana ({}) * scaledManaMultiplier ({})",
                creature->GetName(),
                creatureABInfo->selectedLevel,
                newFinalMana,
                origMana,
        ...
        else
        {
            ...
            TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | scaledManaMultiplier ({}) = manaMultiplier ({})",
                creature->GetName(),
                creatureABInfo->selectedLevel,
                scaledManaMultiplier,
                manaMultiplier
            ...
            TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | newFinalMana ({}) = origMana ({}) * creatureABInfo->ManaMultiplier ({})",
                creature->GetName(),
                creatureABInfo->selectedLevel,
                newFinalMana,
                origMana,
    ...
    //  Armor Scaling
    //
    TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | ---------- ARMOR MULTIPLIER ----------",
        creature->GetName(),
        creatureABInfo->selectedLevel
    );
    ...
    TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | armorMultiplier: ({}) = defaultMultiplier ({}) * statMod_global ({}) * statMod_armor ({})",
        creature->GetName(),
        creatureABInfo->selectedLevel,
        armorMultiplier,
        defaultMultiplier,
    ...
    if (LevelScaling && creatureABInfo->selectedLevel != creatureABInfo->UnmodifiedLevel)
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | origArmor ({}) = origCreatureBaseStats->GenerateArmor(creatureTemplate)",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            origArmor
        );
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | newArmor ({}) = newCreatureBaseStats->GenerateArmor(creatureTemplate)",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            newArmor
        );
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | newArmorMultiplier ({}) = newArmor ({}) / origArmor ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            newArmorMultiplier,
            newArmor,
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | scaledArmorMultiplier ({}) = armorMultiplier ({}) * newArmorMultiplier ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | newFinalArmor ({}) = origArmor ({}) * scaledArmorMultiplier ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            newFinalArmor,
            origArmor,
    ...
    else
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | scaledArmorMultiplier ({}) = armorMultiplier ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            scaledArmorMultiplier,
            armorMultiplier
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | newFinalArmor ({}) = origArmor ({}) * creatureABInfo->ArmorMultiplier ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            newFinalArmor,
            origArmor,
    ...
    //  Damage Scaling
    //
    TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | ---------- DAMAGE MULTIPLIER ----------",
        creature->GetName(),
        creatureABInfo->selectedLevel
    );
    ...
    TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | DamageMultiplier: ({}) = defaultMultiplier ({}) * statMod_global ({}) * statMod_damage ({})",
        creature->GetName(),
        creatureABInfo->selectedLevel,
        damageMultiplier,
        defaultMultiplier,
    ...
    if (damageMultiplier <= MinDamageModifier)
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | DamageMultiplier: ({}) - capped to MinDamageModifier ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            damageMultiplier,
            MinDamageModifier
    ...
    TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | DamageMultiplier: ({})",
        creature->GetName(),
        creatureABInfo->selectedLevel,
    ...
    if (LevelScaling && creatureABInfo->selectedLevel != creatureABInfo->UnmodifiedLevel)
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | origBaseDamage ({}) = origCreatureBaseStats->GenerateBaseDamage(creatureTemplate)",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            origBaseDamage
        );
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | newBaseDamage ({}) = getBaseExpansionValueForLevel(newCreatureBaseStats->BaseDamage, mapABInfo->highestPlayerLevel ({}))",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            newBaseDamage,
            mapABInfo->highestPlayerLevel
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | newDamageMultiplier ({}) = newBaseDamage ({}) / origBaseDamage ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            newDamageMultiplier,
            newBaseDamage,
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | scaledDamageMultiplier ({}) = damageMultiplier ({}) * newDamageMultiplier ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
    ...
    else
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | scaledDamageMultiplier ({}) = damageMultiplier ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            scaledDamageMultiplier,
    ...
    TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | ---------- CC DURATION MULTIPLIER ----------",
        creature->GetName(),
        creatureABInfo->selectedLevel
    );
    ...
    if (statMod_ccDuration != -1.0f)
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | ccDurationMultiplier: ({})",
            creature->GetName(),
            creatureABInfo->selectedLevel,
    ...
    else
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | Crowd Control Duration will not be changed.",
            creature->GetName(),
            creatureABInfo->selectedLevel
        );
    }

    TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | ccDurationMultiplier: ({}) = defaultMultiplier ({}) * statMod_ccDuration ({})",
        creature->GetName(),
        creatureABInfo->selectedLevel,
        ccDurationMultiplier,
        defaultMultiplier,
            ...
            )
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | Summon is a clone of its summoner, keeping health and mana values.",
            creature->GetName(),
            creatureABInfo->selectedLevel
        );
        ...
        if (prevHealth && prevMaxHealth)
        {
            ...
            TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | scaledCurHealth ({}) = prevHealth ({})",
                creature->GetName(),
                creatureABInfo->selectedLevel,
                scaledCurHealth,
                prevHealth
        ...
        if (prevPower && prevMaxPower)
        {
            ...
            TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | scaledCurPower ({}) = prevPower ({})",
                creature->GetName(),
                creatureABInfo->selectedLevel,
                scaledCurPower,
                prevPower
    ...
    else
    {
        if (prevHealth && prevMaxHealth)
        {
            ...
            TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | scaledCurHealth ({}) = float(newFinalHealth) ({}) / float(prevMaxHealth) ({}) * float(prevHealth) ({})",
                creature->GetName(),
                creatureABInfo->selectedLevel,
                scaledCurHealth,
                newFinalHealth,
        ...
        {
            scaledCurHealth = 0;
            TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | scaledCurHealth ({}) = 0",
                creature->GetName(),
                creatureABInfo->selectedLevel,
                scaledCurHealth
            );
        ...
        if (prevPower && prevMaxPower)
        {
            ...
            TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | scaledCurPower ({}) = float(newFinalMana) ({}) / float(prevMaxPower) ({}) * float(prevPower) ({})",
                creature->GetName(),
                creatureABInfo->selectedLevel,
                scaledCurPower,
                newFinalMana,
        ...
        {
            scaledCurPower = 0;
            TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | scaledCurPower ({}) = 0",
                creature->GetName(),
                creatureABInfo->selectedLevel,
                scaledCurPower
            );
    ...
    TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | ---------- REWARD SCALING ----------",
        creature->GetName(),
        creatureABInfo->selectedLevel
    );
    ...
    if (RewardScalingXP || RewardScalingMoney)
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | avgHealthDamageMultipliers ({}) = (scaledHealthMultiplier ({}) + scaledDamageMultiplier ({})) / 2.0f",
            creature->GetName(),
            creatureABInfo->selectedLevel,
    ...
    else
    {
        ...
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | Reward scaling is disabled.",
            creature->GetName(),
            creatureABInfo->selectedLevel
        );
    }
    ...
    if (RewardScalingXP)
    {
        if (RewardScalingMethod == AUTOBALANCE_SCALING_FIXED)
        {
            ...
            TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | Fixed Mode: XPModifier ({}) = RewardScalingXPModifier ({})",
                creature->GetName(),
                creatureABInfo->selectedLevel,
        ...
        else if (RewardScalingMethod == AUTOBALANCE_SCALING_DYNAMIC)
        {
            ...
            TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | Dynamic Mode: XPModifier ({}) = avgHealthDamageMultipliers ({}) * RewardScalingXPModifier ({})",
                creature->GetName(),
                creatureABInfo->selectedLevel,
                creatureABInfo->XPModifier,
                avgHealthDamageMultipliers,
    ...
    if (RewardScalingMoney)
    {
        ...
        if (RewardScalingMethod == AUTOBALANCE_SCALING_FIXED)
        {
            ...
            TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | Fixed Mode: MoneyModifier ({}) = RewardScalingMoneyModifier ({})",
                creature->GetName(),
                creatureABInfo->selectedLevel,
        ...
        else if (RewardScalingMethod == AUTOBALANCE_SCALING_DYNAMIC)
        {
            ...
            TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | Dynamic Mode: MoneyModifier ({}) = avgHealthDamageMultipliers ({}) * RewardScalingMoneyModifier ({})",
                creature->GetName(),
                creatureABInfo->selectedLevel,
                creatureABInfo->MoneyModifier,
                avgHealthDamageMultipliers,
    ...
    TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | ---------- FINAL STATS ----------",
        creature->GetName(),
        creatureABInfo->selectedLevel
    );

    TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | Health ({}/{} {:.1f}%) -> ({}/{} {:.1f}%)",
        creature->GetName(),
        creatureABInfo->selectedLevel,
        prevHealth,
        prevMaxHealth,
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance_StatGeneration", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | Mana ({}/{} {:.1f}%) -> ({}/{} {:.1f}%)",
            creature->GetName(),
            creatureABInfo->selectedLevel,
            prevPower,
            prevMaxPower,
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}->{}) | Multipliers: H:{:.3f}->{:.3f} M:{:.3f}->{:.3f} A:{:.3f}->{:.3f} D:{:.3f}->{:.3f} CC:{:.3f} XP:{:.3f} $:{:.3f}",
            creature->GetName(),
            creatureABInfo->UnmodifiedLevel,
            creatureABInfo->selectedLevel,
            creatureABInfo->HealthMultiplier,
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::ModifyCreatureAttributes: Creature {} ({}) | Multipliers: H:{:.3f} M:{:.3f} A:{:.3f} D:{:.3f} CC:{:.3f} XP:{:.3f} $:{:.3f}",
            creature->GetName(),
            creatureABInfo->UnmodifiedLevel,
            creatureABInfo->HealthMultiplier,
            creatureABInfo->ManaMultiplier,
...
bool AutoBalance_AllCreatureScript::_isSummonCloneOfSummoner(Creature* summon)
{
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::_isSummonCloneOfSummoner: Creature {} ({}) | creatureIDsThatAreNotClones contains this creature's ID ({}) | false",
            summon->GetName(),
    ...
    TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::_isSummonCloneOfSummoner: Creature {} ({}) | Is this a clone of it's summoner {} ({})?",
        summon->GetName(),
        summonABInfo->selectedLevel,
        summoner->GetName(),
        summoner->GetLevel()
    ...
    {
        score += 2;
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::_isSummonCloneOfSummoner: Creature {} ({}) | Entry: ({}) == ({}) | score: +2 = ({})",
            summon->GetName(),
            summonABInfo->selectedLevel,
            summon->GetEntry(),
            summoner->GetEntry(),
    ...
    {
        score += 3;
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::_isSummonCloneOfSummoner: Creature {} ({}) | MaxHealth: ({}) == ({}) | score: +3 = ({})",
            summon->GetName(),
            summonABInfo->selectedLevel,
            summon->GetMaxHealth(),
    ...
    {
        score += 1;
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::_isSummonCloneOfSummoner: Creature {} ({}) | CreatureType: ({}) == ({}) | score: +1 = ({})",
            summon->GetName(),
            summonABInfo->selectedLevel,
    ...
    {
        score += 2;
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::_isSummonCloneOfSummoner: Creature {} ({}) | Name: ({}) == ({}) | score: +2 = ({})",
            summon->GetName(),
            summonABInfo->selectedLevel,
            summon->GetName(),
            summoner->GetName(),
    ...
    {
        score += 1;
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::_isSummonCloneOfSummoner: Creature {} ({}) | Name: ({}) contains ({}) | score: +1 = ({})",
            summon->GetName(),
            summonABInfo->selectedLevel,
            summon->GetName(),
            summoner->GetName(),
    ...
    {
        score += 1;
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::_isSummonCloneOfSummoner: Creature {} ({}) | DisplayId: ({}) == ({}) | score: +1 = ({})",
            summon->GetName(),
            summonABInfo->selectedLevel,
            summon->GetDisplayId(),
    ...
    if (score >= 5)
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::_isSummonCloneOfSummoner: Creature {} ({}) | score ({}) >= 5 | true",
            summon->GetName(),
            summonABInfo->selectedLevel,
            score
        );
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllCreatureScript::_isSummonCloneOfSummoner: Creature {} ({}) | score ({}) < 5 | false",
            summon->GetName(),
            summonABInfo->selectedLevel,
            score
        );

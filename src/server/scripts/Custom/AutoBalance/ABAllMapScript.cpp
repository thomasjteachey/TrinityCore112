...
void AutoBalance_AllMapScript::OnPlayerEnterAll(Map* map, Player* player)
{
    ...
    TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllMapScript::OnPlayerEnterAll: Player {}{} | enters {} ({}{})",
        player->GetName(),
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllMapScript::OnPlayerEnterAll: Player difficulty unchanged at {}. Updating map data (no force).",
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllMapScript::OnPlayerEnterAll: Player difficulty changed from ({})->({}). Updating map data (force).",
...
void AutoBalance_AllMapScript::OnPlayerLeaveAll(Map* map, Player* player)
{
    ...
    TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllMapScript::OnPlayerLeaveAll: Player {}{} | exits {} ({}{})",
        player->GetName(),
        player->IsGameMaster() ? " (GM)" : "",
        map->GetMapName(),
        map->GetId(),
    ...
    TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllMapScript::OnPlayerLeaveAll: There are {} player(s) left in the map.", mapABInfo->allMapPlayers.size());
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllMapScript::OnPlayerLeaveAll: Player difficulty unchanged at {}. Updating map data (no force).",
            mapABInfo->adjustedPlayerCount
        );
    ...
    {
        TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllMapScript::OnPlayerLeaveAll: Player difficulty changed from ({})->({}). Updating map data (force).",
            prevAdjustedPlayerCount,
            mapABInfo->adjustedPlayerCount
        );
    ...
    {
        {
            ...
            TC_LOG_DEBUG("module.AutoBalance", "AutoBalance_AllMapScript::OnPlayerLeaveAll: Player {} left the instance.",
                player->GetName(),
                mapABInfo->playerCount,
                mapABInfo->adjustedPlayerCount
            );

...
-- "X / Y Players Remaining", "X / Y Memories Remaining", and "Wave: X". The rows use StateVariable 9400, the
-- battleground's own show flag, instead of "always visible".
--
-- Both counts now read "X / Y". The denominators are worldstates too:
-- 9405 is the party size the run started with, 9404 is THIS WAVE's clone
-- count - not the run-ending BG_VHR_MAX_ENEMIES cap, which is what 9404
-- used to carry. The top frame reports the fight in front of the party.
--
